...
#pragma mark Main Functions
  public:
     ...
     */
    TreasureView(const std::shared_ptr<cugl::AssetManager>& assets,
                 Vec2 position, Size size) {
        ...
        //            _spriteNodes.push_back(scene2::SpriteNode::allocWithSheet(_spriteSheets[i],
        //            1, 8, 8)); _spriteNodes[i]->setScale(0.4);
    ...
    ~TreasureView() { _node->removeFromParent(); }
...
#pragma mark Scene Methods
  public:
    ...
    //    /**
    //     * Determines the next animation frame for the ship and applies it to
    //     the sprite.
    //     *
    //     * This method includes some dampening of the turn, and should be
    //     called before
    //     * moving the ship.
    //     */
    //    void advanceFrame() {
