...
#pragma mark Static Constructors
   ...
   *
   * This method does NOT load the level. You must call the load() method to do
   * that. This method returns false if file does not exist.
   *
   * @return  an autoreleased level file
   */
...
#pragma mark Asset Loading
   ...
   *
   * This load method should NEVER access the AssetManager.  Assets are loaded
   * and unloaded in parallel, not in sequence.  If an asset (like a game level)
   * has references to other assets, then these should be disconnected earlier.
   */
  void unload();
